defmodule HappyeventWeb.EventControllerTest do
  use HappyeventWeb.ConnCase

  alias Happyevent.Events

  @create_attrs %{description: "some description", is_private: true, lat: 120.5, long: 120.5, title: "some title"}
